...
export const articleTitles = {
  ...
  [Articles.POPULARITY_COUNT]: 'Popularity Count',
...
const personalizeARNToDemoGuideArticleMap = {
  ...
  'arn:aws:personalize:::recipe/aws-personalized-ranking-v2': Articles.PERSONALIZED_RANKING,
  'arn:aws:personalize:::recipe/aws-user-personalization': Articles.USER_PERSONALIZATION,
  'arn:aws:personalize:::recipe/aws-user-personalization-v2': Articles.USER_PERSONALIZATION,
  'arn:aws:personalize:::recipe/aws-popularity-count': Articles.POPULARITY_COUNT,
